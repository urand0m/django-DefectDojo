    ...
    def save(self):
        ...
        try:
            ...
            create_notification(event='other',
                                title="{} completed for project {}".format(test_type,test.engagement.product),
                                description="Info {}, Low {}, Medium {}, High {}, Critical {}".format(severities['Info'],severities['Low'],severities['Medium'],severities['High'],severities['Critical']),
                                icon='bullseye',
