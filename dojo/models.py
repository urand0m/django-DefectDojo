...
class System_Settings(models.Model):
    ...
    delete_dupulicates = models.BooleanField(default=True, blank=False)
    ...
    enable_slack_notifications = \
        models.BooleanField(default=True,
                            ...
                            blank=False)
    slack_channel = models.CharField(max_length=100, default='general', blank=True)
    slack_token = models.CharField(max_length=100, default='xoxp-952302335927-938972731347-952725215542-ea940781a0cec9a3f0afc32fccf6514d', blank=True,
                                   help_text='Token required for interacting '
                                             'with Slack. Get one at '
                                             'https://api.slack.com/tokens')
    slack_username = models.CharField(max_length=100, default='SecurityBot', blank=True)
    ...
    display_endpoint_uri = models.BooleanField(default=True, verbose_name="Display Endpoint Full URI", help_text="Displays the full endpoint URI in the endpoint view.")
    enable_product_grade = models.BooleanField(default=True, verbose_name="Enable Product Grading", help_text="Displays a grade letter next to a product to show the overall health.")
...
class UserContactInfo(models.Model):
    ...
    slack_username = models.CharField(default='cristiano.corrado@gmail.com',blank=True, null=True, max_length=150, help_text="Email address associated with your slack account", verbose_name="Slack Email Address")
